...
<section class="social-posts-content">
	<div class="clearfix">
		...
		<div class="content right">
			...
			<p>Join the conversation by using <a href="#">#progress910</a> to get your social media posts in the mix below.</p>
		</div>
	</div>
		...
		<div class="center">
			...
			<form action="#" class="notify-form" onsubmit="send_invite(); return false;">
				<div class="row">
					...
					<input type="email" value="" name="email_invite" id="email_invite">
				</div>
